...
is($sid, 2, "first user SID is 2 (POE::Kernel is 1)");
...
is($resolved_session, "session", "session ID resolves correctly");
...
is($removed, "session", "session ID removes correctly");
...
is($removed, $poe_kernel, "successfully removed POE::Kernel's SID");
